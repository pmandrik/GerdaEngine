...
//SDL_PROC(void, glTexStorage2D, (GLenum target, GLsizei levels, GLenum internalFormat, GLsizei width, GLsizei height))
...
// framebuffer
SDL_PROC(void, glGenRenderbuffers, (GLsizei n, GLuint *ids))
...
SDL_PROC(void, glBindFramebuffer, (GLenum target, GLuint renderbuffer))
SDL_PROC(void, glFramebufferTexture2D, (GLenum target,GLenum attachment, GLenum texturetarget,GLuint texture, GLint level))
...
SDL_PROC_UNUSED(void, glDisable, (GLenum cap))
...
SDL_PROC_UNUSED(void, glGenTextures, (GLsizei n, GLuint * textures))
...
SDL_PROC_UNUSED(void, glPixelStorei, (GLenum pname, GLint param))
...
SDL_PROC_UNUSED(void, glTexImage1D,
                (GLenum target, GLint level, GLint internalformat,
                 ...
                 const GLvoid * pixels))
SDL_PROC_UNUSED(void, glTexImage2D,
