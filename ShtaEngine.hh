// P.~Mandrik, 2021, https://github.com/pmandrik/ShtaEngine

#ifndef ShtaEngine_H
#define ShtaEngine_H 1

// ======= SDL ====================================================================
#include "SDL.h"
#include "SDL_opengl.h"
#include "ShtaSDL_prerequests.hh"
  ...
  bool init_gerda( string multimedia_library, string render_interface, std::shared_ptr<Config> cfg = nullptr ){
    ...
    if( multimedia_library == "SDL" ){
      ...
      if(not_ok or not sys::FULLSCREEN){
        ...
        window = SDL_CreateWindow("ShtaWindow", 0, 0, sys::WW, sys::WH, SDL_WINDOW_OPENGL);
      }
      else{
        ...
        window = SDL_CreateWindow("ShtaWindow", 0, 0, sys::SW, sys::SH, SDL_WINDOW_OPENGL|SDL_WINDOW_FULLSCREEN);
      }
